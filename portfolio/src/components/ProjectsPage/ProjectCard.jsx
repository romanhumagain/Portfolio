      ...
      <div className='grid grid-cols-12 gap-2 p-6 md:gap-5'>
        ...
        <div className='flex flex-col items-center justify-center col-span-4 gap-5 '>
          <div className='flex flex-col justify-center gap-5 '>
            <img src={food_delivery_app_img} className='cursor-pointer w-[63px] transition-transform duration-700 rounded-lg h-[136px] hover:scale-105 md:h-48 md:w-24' alt='Food Delivery' />
            <img src={news_app} className='cursor-pointer w-[62px] transition-transform duration-700 rounded-lg h-[136px] hover:scale-105 md:h-48 md:w-24' alt='News App' />
          </div>
        </div>
