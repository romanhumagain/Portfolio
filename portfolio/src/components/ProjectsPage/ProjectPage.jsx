  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center h-full min-h-screen' style={{ fontFamily: "Montserrat, sans-serif" }}>
        <div className='w-full max-w-6xl px-4 mt-10 rounded-lg sm:px-8'>
          <SectionHeading title={"Latest Projects"} />
          <div className="grid items-center grid-cols-1 gap-10 py-5 sm:grid-cols-12 md:gap-5 sm:px-10 lg:px-14 rounded-3xl bg-gradient-to-r dark:bg-gradient-to-r from-slate-200 md:from-slate-200 md:via-slate-300 to-slate-300 md:to-slate-400 dark:from-neutral-800 dark:to-neutral-900">
